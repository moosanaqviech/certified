...
Every chapter cites the skill statements it covers (Skill N.M.K numbering from the guide). All 107 skills are mapped; a skill that appears in two chapters is taught once and referenced in the other.
...
| 07 | Cleaning Data: Outliers, Missing Values, and Deduplication |  | `lesson-07-cleaning-data.html` | Skill 1.3.7: detecting outliers, imputing missing data, deduplication |
...
| 11 | SageMaker Feature Store: Ingesting and Managing Features |  | `lesson-11-sagemaker-feature-store.html` | Skills 1.1.9 and 1.2.2: ingesting into Feature Store and managing features |
| 12 | Embedding Models: Turning Text and Images into Vectors |  | `lesson-12-embedding-models.html` | Skill 1.2.5: configuring and using embedding models for numerical representations |
| 13 | Text Pre-Processing: Tokenization and Domain-Specific Augmentation |  | `lesson-13-text-pre-processing.html` | Skill 1.2.6: advanced text pre-processing techniques |
| 14 | Preparing Documents for RAG: Chunking Strategies and Metadata Extraction | TO | `lesson-14-preparing-documents-for-rag.html` | Skill 1.2.7: chunking strategies (fixed, semantic, hierarchical) and metadata for retrieval |
| 15 | Masking, Redaction, and Anonymization |  | `lesson-15-masking-redaction-anonymization.html` | Skill 1.2.8: protecting sensitive data before it reaches a model |
| 16 | Preparing Data for FM Fine-Tuning, Continued Pre-Training, and Distillation | TO | `lesson-16-preparing-data-for-fm-customization.html` | Skill 1.2.9: dataset shapes for each customization path |
